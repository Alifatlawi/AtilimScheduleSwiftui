...
struct DataRow: Codable {
    ...
    let extracolumns, extrarows: [JSONAny]?
...
class JSONNull: Codable, Hashable {
    ...
    public func hash(into hasher: inout Hasher) {
        // Since all instances of JSONNull are equal, they should have the same hash value
        // You could use a constant value, or derive a hash value in some other way
        hasher.combine(0)
    }
